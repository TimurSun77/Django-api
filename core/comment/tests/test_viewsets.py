...
class TestCommentViewSet:
     ...
     ########all the following test are for autorised user ######

     def test_list(self, user, post, client, comment): #
     ...
     def test_delete (self, client, user, post, comment):
      ...
      ########all the following test are for anonymous user ######
     ...
     def test_retrive_anonymous (self, client, post, comment):
     ...
     def test_update_anpnymous (self, client, post, comment):
        data = {
            "body": "Test Comment Body Updated",
            "author":"test_user",
            "post": post.public_id.hex
