...
class TestAuthenticationViewSet:
    ...
    def test_login (self, client, user): # метод для тестирования логин эндпоинта
        data={
            "email": user.email,
    ...
    def test_register(self, client):# метод для тестирования регистарции нового пользователя
        data={
            "username":"johndoe",
